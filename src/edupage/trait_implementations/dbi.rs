...
use crate::edupage::{edupage::Edupage, edupage_traits::DBI};

impl DBI for Edupage {
    fn get_teachers(&self) -> Result<Vec<crate::edupage::edupage_types::Teacher>, EdupageError> {
    ...
    fn get_teacher_by_id(
        &self,
        id: i64,
    ) -> Result<Option<crate::edupage::edupage_types::Teacher>, EdupageError> {
        if !self.is_logged_in {
            return Err(EdupageError::NotLoggedIn);
        }
    ...
    fn get_students(&self) -> Result<Vec<crate::edupage::edupage_types::Student>, EdupageError> {
        if !self.is_logged_in {
            return Err(EdupageError::NotLoggedIn);
        }
    ...
    fn get_student_by_id(
        &self,
        id: i64,
    ) -> Result<Option<crate::edupage::edupage_types::Student>, EdupageError> {
        if !self.is_logged_in {
            return Err(EdupageError::NotLoggedIn);
        }
    ...
    fn get_subjects(&self) -> Result<Vec<crate::edupage::edupage_types::DBIBase>, EdupageError> {
        if !self.is_logged_in {
            return Err(EdupageError::NotLoggedIn);
        }
    ...
    fn get_subject_by_id(
        &self,
        id: i64,
    ) -> Result<Option<crate::edupage::edupage_types::DBIBase>, EdupageError> {
        if !self.is_logged_in {
            return Err(EdupageError::NotLoggedIn);
        }
    ...
    fn get_classrooms(&self) -> Result<Vec<crate::edupage::edupage_types::DBIBase>, EdupageError> {
        if !self.is_logged_in {
            return Err(EdupageError::NotLoggedIn);
        }
    ...
    fn get_classroom_by_id(&self, id: i64) -> Result<Option<edupage_types::DBIBase>, EdupageError> {
        if !self.is_logged_in {
            return Err(EdupageError::NotLoggedIn);
        }
